                        ...
                        Material(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              height: 50,
                              width: 50,
                              child: Icon(Entypo.cross,color: Colors.red,),
                            ),
                          ),
                        ),
                      ],
                      ...
                      children: [
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              child: Padding(
                                ...
                                child: Icon(Entypo.minus,color: Colors.red,),
                              ),
                            ),
                          ),
                        ),
                        Card(
                          ...
                          child: Container(
                            ...
                            child: Text('${cartAttribute.quantity}',textAlign: TextAlign.center,),
                          ),
                        ),
                        Material(
                          color: Colors.transparent,
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(5.0),
                                child: Icon(Entypo.plus,color: Colors.green,),
                              ),
                            ),
                          ),
                        ),
